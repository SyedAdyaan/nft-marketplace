...
export default function Navbar(){
    return(
        <div className="App" class="px-6">
      <nav class="relative px-4 py-4 flex justify-between items-center shadow-lg">
		...
		<ul class="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:flex lg:items-center lg:w-auto lg:space-x-6">
			<li><a class="text-sm text-blue-600 hover:text-gray-500 font-bold" href="#">Home</a></li>
		...
		<nav class="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-auto">
			...
			<div class="mt-auto">
				<div class="pt-6">
					...
					<a class="block px-4 py-3 mb-2 leading-loose text-xs text-center text-white font-semibold bg-blue-800 hover:bg-blue-700  rounded-xl" href="#">Sign Up</a>
				</div>
